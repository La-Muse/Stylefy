      ...
      <div className="p-4">
        ...
        <div className="grid grid-cols-2 gap-3 mb-4">
          <div className="bg-white rounded-sm p-4 text-center">
            <i className="fas fa-tshirt text-gray-900 text-2xl mb-2" />
            <h3 className="font-semibold mb-1">保存したコーデ</h3>
            <p className="text-gray-900 text-2xl font-bold">27</p>
          </div>
          <div className="bg-white rounded-sm p-4 text-center">
            <i className="fas fa-comment-alt text-gray-900 text-2xl mb-2" />
        ...
        <div className="mb-4">
          ...
          <div className="bg-white rounded-sm overflow-hidden">
            {settingsItems.map((item, index) => (
              ...
              >
                <i className={`${item.icon} text-gray-500 text-xl mr-3`} />
