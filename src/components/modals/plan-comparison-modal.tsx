                ...
                <tr key={index} className="border-b border-gray-200">
                  ...
                  <td className="text-center p-2">
                    {typeof feature.free === "boolean" ? (
                      <i className={`fas ${feature.free ? "fa-check text-green-500" : "fa-times text-red-500"}`} />
                    ) : (
                      feature.free
                    )}
                  </td>
                  <td className="text-center p-2">
                    {typeof feature.light === "boolean" ? (
                      <i className={`fas ${feature.light ? "fa-check text-green-500" : "fa-times text-red-500"}`} />
                    ) : (
                      feature.light
                    )}
                  </td>
                  <td className="text-center p-2">
                    {typeof feature.premium === "boolean" ? (
                      <i className={`fas ${feature.premium ? "fa-check text-green-500" : "fa-times text-red-500"}`} />
                    ) : (
                      feature.premium
                    )}
                  </td>
