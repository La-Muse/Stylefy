  ...
  const bodyTypes = [
    {
      ...
      icon: (
        <div className="flex justify-center items-center">
          <div className="w-0.5 h-11 bg-gray-900 mx-1.5" />
          <div className="w-0.5 h-11 bg-gray-900 mx-1.5" />
        </div>
      ),
    },
    {
      ...
      icon: (
        <div className="flex justify-center items-center">
          <div className="w-0.5 h-11 bg-gray-900 mx-1.5 rounded-sm transform -rotate-2" />
          <div className="w-0.5 h-11 bg-gray-900 mx-1.5 rounded-sm transform rotate-2" />
        </div>
      ),
    },
    {
      ...
      icon: (
        <div className="flex justify-center items-center">
          <div className="w-1 h-11 bg-gray-900 rounded-full transform -rotate-3" />
          <div className="w-1 h-11 bg-gray-900 rounded-full transform rotate-3" />
        </div>
      ),
    },
    ...
    <div className="h-full">
      ...
      <div className="p-4">
          ...
          {bodyTypes.map((type) => (
            ...
            >
              <div className="flex items-center">
                ...
                >
                  {selectedType === type.id && <i className="fas fa-check text-white text-xs" />}
                </div>
              </div>
            </button>
          ))}
        ...
        <div className="flex gap-2 mt-6">
          ...
          <Button onClick={() => {}} disabled={!selectedType} className="flex-1">
            次へ
          </Button>
        </div>
      </div>
