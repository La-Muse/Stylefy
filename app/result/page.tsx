        ...
        <div className="bg-white rounded-md shadow-lg overflow-hidden mb-4">
          ...
          <div className="bg-gradient-to-br from-gray-800 to-gray-900 text-white p-8 text-center relative">
            ...
            <div className="flex justify-center mb-5">
              <div className="w-0.5 h-24 bg-white mx-2"></div>
              <div className="w-0.5 h-24 bg-white mx-2"></div>
            </div>
          ...
          <div className="p-6">
            ...
            <div className="grid grid-cols-3 gap-4 mb-6">
              <div className="text-center bg-gray-100 p-4 rounded-md">
                <i className="fas fa-tshirt text-gray-900 text-xl mb-2"></i>
              ...
              <div className="text-center bg-gray-100 p-4 rounded-md">
                <i className="fas fa-ruler-vertical text-gray-900 text-xl mb-2"></i>
              ...
              <div className="text-center bg-gray-100 p-4 rounded-md">
                <i className="fas fa-tags text-gray-900 text-xl mb-2"></i>
